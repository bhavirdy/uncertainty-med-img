#!/bin/bash
#SBATCH --job-name=isic2018_mcdo
#SBATCH --output=logs/isic2018_mcdo_%j.out
#SBATCH --error=logs/isic2018_mcdo_%j.err
#SBATCH --partition=bigbatch
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=24:00:00
#SBATCH --exclude=mscluster42,mscluster44,mscluster48,mscluster65,mscluster75,mscluster76
