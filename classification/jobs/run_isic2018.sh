...
sed "s|{OUTPUT_DIR}|$RUN_DIR/train|g" ./classification/configs/isic2018_train_config.yaml > "$TRAIN_CONFIG"
...
sed "s|{OUTPUT_DIR}|$RUN_DIR/eval|g; s|{MODEL_PATH}|$MODEL_PATH|g" \
    ./classification/configs/isic2018_eval_config.yaml > "$EVAL_CONFIG"
...
#     ./classification/configs/isic2018_infer_config.yaml > "$INFER_CONFIG"
