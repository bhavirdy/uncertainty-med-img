...
def get_aptos_loaders(train_csv="./classification/datasets/aptos2019/train_split.csv",
    ...
    train_set = APTOSDataset(train_csv, img_dir, transform=train_tf, circle_crop=circle_crop)
    val_set = APTOSDataset(val_csv, img_dir, transform=val_tf, circle_crop=circle_crop)
    test_set = APTOSDataset(test_csv, img_dir, transform=val_tf, circle_crop=circle_crop)
